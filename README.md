...
“完成收藏操作，进行页面关闭”，可以写成“收藏完，关了页面”。把动作从绕口的名词结构里拿出来，句子就顺了。事情发生的顺序、是否已经做完，仍按材料保留。

![改前写着“完成收藏操作、进行页面关闭”，改后写成“收藏完、关了页面”。手绘人物与机器人一起调整句子，让动作直接出现。](docs/images/language-before-after.png)

### 从一个细节，写到为什么在意

比如整理一张旅行合影：笑脸还在，却想不起大家为什么笑。沿着这个差别追问，才发现照片留下了地点和表情，却没留下那句逗笑大家的话。下次拍合影，也在照片旁记一句当时的话。作者珍惜什么，就从这个小动作里显出来了。

![意义从细节生长：先看合影里的笑脸，再追问为什么笑，比较还能找回的地点与忘掉的话，最后落到以后在照片旁记下一句话。四步依次是锚定、追问、架桥、落点。](docs/images/meaning-from-details.png)

图让改动和思考的路径可见。配图时也按这个标准选择位置，让每幅图帮读者看清一处。
